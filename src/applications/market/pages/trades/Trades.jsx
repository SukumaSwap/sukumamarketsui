        ...
        <tr key={`${trade?.id}`}>
            ...
            }
            {
                getHeader("buyer")?.show && (
                    <td>
                        <NavLink px={0} label={getTextCount(trade.buyer, 20)} to={`/market/accounts/${trade.buyer}`} component={Link} />
                    </td>
                )
            }
            {
                getHeader("seller")?.show && (
                    <td>
                        <NavLink px={0} label={getTextCount(trade.seller, 20)} to={`/market/accounts/${trade.seller}`} component={Link} />
                    </td>
                )
            }
            {
                ...
                getHeader("chat_id")?.show && (
                    <td>
                        <Button radius="xl" color="green" style={{
                            width: "120px"
                        }} onClick={e => goTo(`/market/chats/${trade.chat_id}/`)}>View</Button>
                    </td>
                )
            }
        </tr>
