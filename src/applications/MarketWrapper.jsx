...
import { IconCopy, IconCopyright, IconHome, IconSocial, IconWriting } from '@tabler/icons';
...
export default function MarketWrapper({ url_prefix, depositmodal, withdrawmodal}) {
          ...
          <Navbar.Section grow py="md" px="sm" component={ScrollArea}>
              ...
              <div>
                ...
                }} openSidebar={openSidebar} />
                {
                  navbarlinks.map((link, i) => (
                    <CustomNavlink key={`sidebar_link__nav_${i}`} url_prefix={url_prefix} navlink={link} openSidebar={openSidebar} />
                  ))
                }
            ...
            </MediaQuery>
            {
              dashboard_links.map((link, i) => (
                <CustomNavlink key={`sidebar_link__${i}`} url_prefix={url_prefix} navlink={link} openSidebar={openSidebar} />
              ))
            }
          </Navbar.Section>
          ...
          <div style={{ display: 'flex', alignItems: 'center', height: '100%', justifyContent: "space-between" }}>
            ...
            <MediaQuery smallerThan="md" styles={{ display: 'none !important' }}>
              <Group>
                {
                  navbarlinks.map((link, i) => (
                    <CustomNavbarLink key={`sidebar_link__nav_other_${i}`} url_prefix={url_prefix} obj={link} />
                  ))
                }
              </Group>
            </MediaQuery>
