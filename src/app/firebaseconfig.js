...
import { getFirestore, collection, where, doc, getDocs, QuerySnapshot, query, getDoc, addDoc, setDoc, updateDoc, serverTimestamp, arrayUnion, onSnapshot, DocumentSnapshot, Timestamp } from 'firebase/firestore'
...
// Firestore database
export { db, collection, where, query, QuerySnapshot, doc, getDoc, getDocs, addDoc, setDoc, updateDoc, serverTimestamp, arrayUnion, onSnapshot, DocumentSnapshot, Timestamp }
